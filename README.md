...
running command...
$ spb (--version)
@hesed/supabase/0.2.1 linux-x64 node-v20.20.0
$ spb --help [COMMAND]
USAGE
  $ spb COMMAND
...
...
_See code: [src/commands/supabase/auth/add.ts](https://github.com/hesedcasa/supabase/blob/v0.2.1/src/commands/supabase/auth/add.ts)_
...
_See code: [src/commands/supabase/auth/test.ts](https://github.com/hesedcasa/supabase/blob/v0.2.1/src/commands/supabase/auth/test.ts)_
...
_See code: [src/commands/supabase/auth/update.ts](https://github.com/hesedcasa/supabase/blob/v0.2.1/src/commands/supabase/auth/update.ts)_
...
_See code: [src/commands/supabase/create.ts](https://github.com/hesedcasa/supabase/blob/v0.2.1/src/commands/supabase/create.ts)_
...
_See code: [src/commands/supabase/delete.ts](https://github.com/hesedcasa/supabase/blob/v0.2.1/src/commands/supabase/delete.ts)_
...
_See code: [src/commands/supabase/query.ts](https://github.com/hesedcasa/supabase/blob/v0.2.1/src/commands/supabase/query.ts)_
...
_See code: [src/commands/supabase/table-columns.ts](https://github.com/hesedcasa/supabase/blob/v0.2.1/src/commands/supabase/table-columns.ts)_
...
_See code: [src/commands/supabase/tables.ts](https://github.com/hesedcasa/supabase/blob/v0.2.1/src/commands/supabase/tables.ts)_
...
_See code: [src/commands/supabase/update.ts](https://github.com/hesedcasa/supabase/blob/v0.2.1/src/commands/supabase/update.ts)_
<!-- commandsstop -->
